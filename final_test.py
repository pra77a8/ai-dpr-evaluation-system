"""
Final test script for the enhanced NLP extractor with the three specific DPR templates
"""
...
def test_template(pdf_file, pdf_name):
    """Test a single DPR template"""
...
if __name__ == "__main__":
    ...
    test_template("sample_dpr.pdf", "Sample DPR Template")
    test_template("Model_DPR_Final 2.0.pdf", "Model DPR Final 2.0")
    test_template("BridgesDPRTemplate[1].pdf", "Bridges DPR Template")