"""
Simple test for just the specialized extractor
"""
...
def simple_test():
    """Simple test for the specialized extractor"""
    print("=== Simple Specialized Extractor Test ===")
    ...
    if result.project_title == "Road Construction and Community Development Project":
        print("✅ SUCCESS: Specialized extractor is working correctly!")
